...
<style>
  ...
  * {box-sizing: border-box;}
  body { text-align: center; padding: 0; background: #44a01a; color: #fff; font-family: Open Sans; }
...
<article>
    <img src="{{ asset('img/KLHK_Logo.png') }}" alt="" width="200px">
